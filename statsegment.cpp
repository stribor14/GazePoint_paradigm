...
statSegment::statSegment(const segParams &parameters) :
    params(parameters)
{
    red_dot = new QDot(0, 0, params.dotSize, QBrush(Qt::red));
}
...
void statSegment::setDotSize()
{
    red_dot->setSize(params.dotSize);
}
